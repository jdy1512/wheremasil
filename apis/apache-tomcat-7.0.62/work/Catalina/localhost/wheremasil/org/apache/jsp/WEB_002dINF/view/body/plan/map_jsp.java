 ...
 * Generated at: 2015-06-17 02:26:18 UTC
...
public final class map_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t$(\".left_nav\").css(\"height\", \"800px\");\n");
      out.write("\t\t$(\".right_nav\").css(\"height\", \"800px\");\n");
      ...
      out.write("\t\t    \t\t            });\n");
      out.write("\t\t    \t\t            \n");
      out.write("\t\t    \t\t            daum.maps.event.addListener(marker, 'mouseup', function() {\n");
      out.write("\t\t    \t\t    \t\t\tbounds = new daum.maps.LatLngBounds(marker.getPosition(), marker.getPosition());\n");
      ...
      out.write("\t\t    \tvar dupFlg = false;\n");
      out.write("\t\t\t\tvar regExp = /[\\s*\\{\\}\\[\\]\\/?.,;:|\\)*~`!^\\-_+<>@\\#$%&\\\\\\=\\(\\'\\\"]/gi;\n");
      out.write("\t\t\t\tvar fixedTitle = places[i].title.replace(regExp, '');\n");
      out.write("\t\t    \tfor (var idx = 0; idx < titles.length; idx++) {\n");
      out.write("\t\t\t\t\tif (fixedTitle == titles[idx]) {\n");
      out.write("\t\t\t\t\t\tdupFlg = !dupFlg;\n");
      out.write("\t\t\t\t\t\tbreak;\n");
      out.write("\t\t\t\t\t}\n");
      out.write("\t\t    \t}\n");
      out.write("\t\n");
      ...
      out.write("\t\t    \tif (dupFlg) {\n");
      out.write("\t\t    \t\tfor (var idx = 0; idx < areaMarkers.length; idx++) {\n");
      out.write("\t\t    \t\t\tif (areaMarkers[idx].getTitle() == places[i].title) {\n");
      out.write("\t\t    \t\t\t\tmarker = areaMarkers[idx];\n");
      out.write("\t\t    \t\t\t}\n");
      out.write("\t\t    \t\t}\n");
      out.write("\t\t    \t}\n");
      ...
      out.write("\t\t            daum.maps.event.addListener(marker, 'mouseup', function() {\n");
      out.write("\t\t    \t\t\tbounds = new daum.maps.LatLngBounds();\n");
      out.write("\t\t    \t\t\textendsBounds(marker.getPosition());\n");
      out.write("\t\t    \t\t\tmap.setBounds(bounds);\n");
      out.write("\t\t                infowindow.close();\n");
      out.write("\t\t                displayInfowindow(marker, title, addr, img);\n");
      out.write("\t\t            });\n");
