         ...
         function() {
            ...
            $("#login_send").on(
                  ...
                  function() {
                     ...
                     $.ajax({
                        url : "/wheremasil/member/sessionlogincheck.do",
                        data : editor1,
                        type : "post",
                        dataType : "text",
         ...
         <form class="navbar-form navbar-right" role="search">
            ...
            <c:if test="${sessionScope.login_info == null}">
               ...
               <button id="login_form_bt" type="button"
                  class="btn btn-default navbar-btn" onclick="fn_layer_popup_login()">로그인</button>
...
<div id="popup_layer_login"
   ...
   <div id="login_form_header" class="panel panel-warning">
      <div class="panel-heading">
         <h4 class="panel-title" align="right"><a href="#" onclick="fn_layer_popup_join()">회원가입</a></h4>
      </div>
         ...
         <form class="form-horizontal" action="">
            <fieldset>
               ...
               <div class="form-group">
                  ...
                  <div class="col-lg-7">
                     <input type="text" class="form-control" id="member_id" name="member_id"   placeholder="email주소" autofocus required>
                  </div>
               </div>
               <div class="form-group">
                  <label for="inputTitle" class="col-lg-3 control-label">패스워드</label>
                  <div class="col-lg-7">
                     <input type="password" class="form-control" id="m_password" name="m_password" placeholder="password" autofocus required>
                  </div>
               </div>

               <div class="form-group" >
                   <div class="col-lg-7 col-lg-offset-4">
                      <input type="button" id="login_send" class="btn btn-warning" value="로그인">
                         <input type="reset"  id="popup_cancel_login" class="btn btn-default" value="취소">
                   </div>
               </div>
            </fieldset>
         </form>
         ...
         <form class="form-horizontal" action="">
            <fieldset>
               ...
               <div class="form-group">
                  <label for="inputTitle" class="col-lg-3 control-label">이메일</label>
                  <div class="col-lg-7">
                     <input type="text" class="form-control" id="member_id1" name="member_id1"  value="${param.email }"   placeholder="email주소" autofocus required>
                  </div>
               </div>
               <div class="form-group">
                  <label for="inputTitle" class="col-lg-3 control-label">패스워드</label>
                  <div class="col-lg-7">
                     <input type="password" class="form-control" id="m_password1" name="m_password" placeholder="password" autofocus required>
                  </div>
               </div>
               <div class="form-group">
                  <label for="inputTitle" class="col-lg-3 control-label">닉네임</label>
                  <div class="col-lg-7">
                     <input type="text" class="form-control" id="m_name1" name="m_name" placeholder="닉네임" autofocus required>
                  </div>
               </div>
               <div class="form-group" >
                   <div class="col-lg-7 col-lg-offset-4">
